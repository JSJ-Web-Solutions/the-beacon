      ...
      <div className="guide__text-container">
        ...
        <ol>
          <li className="guide__text-li">
            ...
            to have $Magic and ETH in our digital wallet. @Add founds to your
            wallet
          </li>
          <li className="guide__text-li">
            Go to
        ...
        <p className="guide__text-p">
          ...
          https://app.thebeacon.gg/. Ensure that you are signed in to your
          account by clicking on "Sign In." Once logged in, access your profile
          by clicking on it at the top right corner. To view your characters
          click characters.
        </p>
        <p className="guide__text-p">
        ...
        <ol>
          <li className="guide__text-li">
            https://app.thebeacon.gg/ then click your profile and go to
            characters.
          </li>
          <li className="guide__text-li">
        ...
        <ol>
          <li className="guide__text-li">Go to https://app.treasure.lol/.</li>
